  ...
  PictureMarkerSymbol) 
	{
		...
		*****************************************************************/ 
		...
		let layer = new MapImageLayer({
			url: "https://" + window.location.host + "/arcgis/rest/services/maps/ISW/MapServer",
		...
		let watersLayer = new MapImageLayer({
			...
			sublayers: [
				...
				{
					id: 15,
					title: "Wild Rivers and Streams - ORVW Prohibited Discharge",
					popupTemplate: {
						title: "Wild Rivers and Streams - ORVW Prohibited Discharge",
						content: "Name: {Name} <br /> ORVW Status: {ORVWStatus}"
					}
				},
				{
					id: 7,
				...
				{
					id: 21,
					title: "Trout Lake - Minn R. 6264 Listed",
					popupTemplate: {
						title: "Trout Lake - Minn R. 6264 Listed",
						content: "Name: {PW_BASIN_N}"
					}
				},
				{
					id: 20,
					title: "Trout Lake - Minn R 7050 Listed",
					popupTemplate: {
						title: "Trout Lake - Minn R 7050 Listed",
						content: "Name: {lake_name} <br />WID: {wid}"
					}
				},
				{
					id: 19,
					title: "Trout Stream - Minn R. 6264 Listed",
					popupTemplate: {
						title: "Trout Stream - Minn R. 6264 Listed",
						content: "Name: {KITTLE_NAM}"
					}
				},
				{
					id: 18,
					title: "Trout Stream - Minn R 7050 Listed",
					popupTemplate: {
						title: "Trout Stream - Minn R 7050 Listed",
						content: "Name: {reach_name} <br />WID: {wid}"
					}
				},
				{
					id: 9,
...
*/
		...
		*****************************************************************/ 
		...
		url:
			"https://" + window.location.host + "/arcgis/rest/services/maps/ISW/MapServer"
		});
	...
	//	view.ui.add(["distance", "area", "clear"], 'top-left');
		...
		*****************************************************************/ 
		let theURL = "https://" + window.location.host + "/arcgis/rest/services/maps/ISW/MapServer/legend";
		esriRequest(theURL, {
			query: {
				f: 'json'
			},
