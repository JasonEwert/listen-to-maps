...
(function() {
  ...
  function setupShepherd() {
      ...
      steps: [
        {
          ...
          text: 'Enter an Industrial Stormwater ID (permit number or No Exposure number) to search for special and impaired waters within 1 mile of the associate monitoring locations as applicable.',
          attachTo: {
            element: '#inputTxt',
            on: 'right'
          },
    ...
    const steps = [
        ...
        text: 'If you do not know your Industrial Stormwater ID, which is your permit number or No Exposure number you can search for them by clicking on the blue link which will bring you to a data driven webpage.',
        attachTo: {
          element: '#iswLookup',
          on: 'right'
        },
      ...
      },
	  {
        ...
        text: 'For facilities that are applying for permit coverage, and need a facility map (permit item 32.2), use this option to search for and create a map of special and impaired waters within one mile of any location.',
        attachTo: {
          element: '#pointSearch',
          on: 'right'
        },
    ...
    shepherd.addStep({
      title: 'Map Search',
      text: 'Search by address, Industrial Stormwater ID (permit number or No Exposure number) or latitude/longitude coordinates to zoom to a location. ',
      attachTo: {
        element: '.esri-search',
        on: 'left'
      },
