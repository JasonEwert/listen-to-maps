...
gtag('js', new Date());
gtag('config', 'UA-140352188-1');</script><meta charSet="utf-8"/><meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/><meta name="description" content="The CDN for downloadjs"/><meta name="viewport" content="width=device-width,initial-scale=1,maximum-scale=1"/><meta name="timestamp" content="2021-11-12T21:26:23.463Z"/><link rel="shortcut icon" href="/favicon.ico"/><title>UNPKG - downloadjs</title><script>window.Promise || document.write('\x3Cscript src="/es6-promise@4.2.5/dist/es6-promise.min.js">\x3C/script>\x3Cscript>ES6Promise.polyfill()\x3C/script>')</script><script>window.fetch || document.write('\x3Cscript src="/whatwg-fetch@3.0.0/dist/fetch.umd.js">\x3C/script>')</script><script>window.__DATA__ = {"packageName":"downloadjs","packageVersion":"1.4.7","availableVersions":["1.3.1","1.4.1","1.4.2","1.4.3","1.4.4","1.4.6","1.4.7"],"filename":"/download.min.js","target":{"path":"/download.min.js","type":"file","details":{"contentType":"application/javascript","integrity":"sha384-fcq+FmM9tqGUeb2KuKl26ktwu/FxKAe200X+jtjXtbF3oCgVdr2GHQrC/+hZJJXg","language":"JavaScript","size":2547,"uri":null,"highlights":["<span class=\"code-comment\">//download.js v4.2, by dandavis; 2008-2017. [MIT] see http://danml.com/download.html for tests/usage</span>\n",";(<span class=\"code-function\"><span class=\"code-keyword\">function</span>(<span class=\"code-params\">r,l</span>)</span>{<span class=\"code-string\">\"function\"</span>==<span class=\"code-keyword\">typeof</span> define&amp;&amp;define.amd?define([],l):<span class=\"code-string\">\"object\"</span>==<span class=\"code-keyword\">typeof</span> exports?<span class=\"code-built_in\">module</span>.exports=l():r.download=l()})(<span class=\"code-keyword\">this</span>,<span class=\"code-function\"><span class=\"code-keyword\">function</span>(<span class=\"code-params\"></span>)</span>{<span class=\"code-keyword\">return</span> <span class=\"code-function\"><span class=\"code-keyword\">function</span> <span class=\"code-title\">l</span>(<span class=\"code-params\">a,e,k</span>)</span>{<span class=\"code-function\"><span class=\"code-keyword\">function</span> <span class=\"code-title\">q</span>(<span class=\"code-params\">a</span>)</span>{<span class=\"code-keyword\">var</span> h=a.split(<span class=\"code-regexp\">/[:;,]/</span>);a=h[<span class=\"code-number\">1</span>];<span class=\"code-keyword\">var</span> h=(<span class=\"code-string\">\"base64\"</span>==h[<span class=\"code-number\">2</span>]?atob:<span class=\"code-built_in\">decodeURIComponent</span>)(h.pop()),d=h.length,b=<span class=\"code-number\">0</span>,c=<span class=\"code-keyword\">new</span> <span class=\"code-built_in\">Uint8Array</span>(d);<span class=\"code-keyword\">for</span>(b;b&lt;d;++b)c[b]=h.charCodeAt(b);<span class=\"code-keyword\">return</span> <span class=\"code-keyword\">new</span> f([c],{<span class=\"code-attr\">type</span>:a})}<span class=\"code-function\"><span class=\"code-keyword\">function</span> <span class=\"code-title\">m</span>(<span class=\"code-params\">a,b</span>)</span>{<span class=\"code-keyword\">if</span>(<span class=\"code-string\">\"download\"</span><span class=\"code-keyword\">in</span> d)<span class=\"code-keyword\">return</span> d.href=a,d.setAttribute(<span class=\"code-string\">\"download\"</span>,n),d.className=<span class=\"code-string\">\"download-js-link\"</span>,d.innerHTML=<span class=\"code-string\">\"downloading...\"</span>,d.style.display=<span class=\"code-string\">\"none\"</span>,<span class=\"code-built_in\">document</span>.body.appendChild(d),setTimeout(<span class=\"code-function\"><span class=\"code-keyword\">function</span>(<span class=\"code-params\"></span>)</span>{d.click(),<span class=\"code-built_in\">document</span>.body.removeChild(d),!<span class=\"code-number\">0</span>===b&amp;&amp;setTimeout(<span class=\"code-function\"><span class=\"code-keyword\">function</span>(<span class=\"code-params\"></span>)</span>{g.URL.revokeObjectURL(d.href)},<span class=\"code-number\">250</span>)},<span class=\"code-number\">66</span>),!<span class=\"code-number\">0</span>;<span class=\"code-keyword\">if</span>(<span class=\"code-regexp\">/(Version)\\/(\\d+)\\.(\\d+)(?:\\.(\\d+))?.*Safari\\//</span>.test(navigator.userAgent))<span class=\"code-keyword\">return</span><span class=\"code-regexp\">/^data:/</span>.test(a)&amp;&amp;(a=<span class=\"code-string\">\"data:\"</span>+a.replace(<span class=\"code-regexp\">/^data:([\\w\\/\\-\\+]+)/</span>,<span class=\"code-string\">\"application/octet-stream\"</span>)),!<span class=\"code-built_in\">window</span>.open(a)&amp;&amp;confirm(<span class=\"code-string\">\"Displaying New Document\\n\\nUse Save As... to download, then click back to return to this page.\"</span>)&amp;&amp;(location.href=a),!<span class=\"code-number\">0</span>;<span class=\"code-keyword\">var</span> c=<span class=\"code-built_in\">document</span>.createElement(<span class=\"code-string\">\"iframe\"</span>);<span class=\"code-built_in\">document</span>.body.appendChild(c),!b&amp;&amp;<span class=\"code-regexp\">/^data:/</span>.test(a)&amp;&amp;(a=<span class=\"code-string\">\"data:\"</span>+a.replace(<span class=\"code-regexp\">/^data:([\\w\\/\\-\\+]+)/</span>,<span class=\"code-string\">\"application/octet-stream\"</span>)),c.src=a,setTimeout(<span class=\"code-function\"><span class=\"code-keyword\">function</span>(<span class=\"code-params\"></span>)</span>{<span class=\"code-built_in\">document</span>.body.removeChild(c)},<span class=\"code-number\">333</span>)}<span class=\"code-keyword\">var</span> g=<span class=\"code-built_in\">window</span>,b=k||<span class=\"code-string\">\"application/octet-stream\"</span>,c=!e&amp;&amp;!k&amp;&amp;a,d=<span class=\"code-built_in\">document</span>.createElement(<span class=\"code-string\">\"a\"</span>);k=<span class=\"code-function\"><span class=\"code-keyword\">function</span>(<span class=\"code-params\">a</span>)</span>{<span class=\"code-keyword\">return</span> <span class=\"code-built_in\">String</span>(a)};<span class=\"code-keyword\">var</span> f=g.Blob||g.MozBlob||g.WebKitBlob||k,n=e||<span class=\"code-string\">\"download\"</span>,f=f.call?f.bind(g):Blob;<span class=\"code-string\">\"true\"</span>===<span class=\"code-built_in\">String</span>(<span class=\"code-keyword\">this</span>)&amp;&amp;(a=[a,b],b=a[<span class=\"code-number\">0</span>],a=a[<span class=\"code-number\">1</span>]);<span class=\"code-keyword\">if</span>(c&amp;&amp;<span class=\"code-number\">2048</span>&gt;c.length&amp;&amp;(n=c.split(<span class=\"code-string\">\"/\"</span>).pop().split(<span class=\"code-string\">\"?\"</span>)[<span class=\"code-number\">0</span>],d.href=c,<span class=\"code-number\">-1</span>!==d.href.indexOf(c))){<span class=\"code-keyword\">var</span> p=<span class=\"code-keyword\">new</span> XMLHttpRequest;<span class=\"code-keyword\">return</span> p.open(<span class=\"code-string\">\"GET\"</span>,c,!<span class=\"code-number\">0</span>),p.responseType=<span class=\"code-string\">\"blob\"</span>,p.onload=<span class=\"code-function\"><span class=\"code-keyword\">function</span>(<span class=\"code-params\">a</span>)</span>{l(a.target.response,n,<span class=\"code-string\">\"application/octet-stream\"</span>)},setTimeout(<span class=\"code-function\"><span class=\"code-keyword\">function</span>(<span class=\"code-params\"></span>)</span>{p.send()},<span class=\"code-number\">0</span>),p}<span class=\"code-keyword\">if</span>(<span class=\"code-regexp\">/^data:([\\w+-]+\\/[\\w+.-]+)?[,;]/</span>.test(a)){<span class=\"code-keyword\">if</span>(!(<span class=\"code-number\">2096103.424</span>&lt;a.length&amp;&amp;f!==k))<span class=\"code-keyword\">return</span> navigator.msSaveBlob?navigator.msSaveBlob(q(a),n):m(a);a=q(a),b=a.type||<span class=\"code-string\">\"application/octet-stream\"</span>}<span class=\"code-keyword\">else</span> <span class=\"code-keyword\">if</span>(<span class=\"code-regexp\">/([\\x80-\\xff])/</span>.test(a)){e=<span class=\"code-number\">0</span>;<span class=\"code-keyword\">var</span> c=<span class=\"code-keyword\">new</span> <span class=\"code-built_in\">Uint8Array</span>(a.length),t=c.length;<span class=\"code-keyword\">for</span>(e;e&lt;t;++e)c[e]=a.charCodeAt(e);a=<span class=\"code-keyword\">new</span> f([c],{<span class=\"code-attr\">type</span>:b})}a=a <span class=\"code-keyword\">instanceof</span> f?a:<span class=\"code-keyword\">new</span> f([a],{<span class=\"code-attr\">type</span>:b});<span class=\"code-keyword\">if</span>(navigator.msSaveBlob)<span class=\"code-keyword\">return</span> navigator.msSaveBlob(a,n);<span class=\"code-keyword\">if</span>(g.URL)m(g.URL.createObjectURL(a),!<span class=\"code-number\">0</span>);<span class=\"code-keyword\">else</span>{<span class=\"code-keyword\">if</span>(<span class=\"code-string\">\"string\"</span>==<span class=\"code-keyword\">typeof</span> a||a.constructor===k)<span class=\"code-keyword\">try</span>{<span class=\"code-keyword\">return</span> m(<span class=\"code-string\">\"data:\"</span>+b+<span class=\"code-string\">\";base64,\"</span>+g.btoa(a))}<span class=\"code-keyword\">catch</span>(h){<span class=\"code-keyword\">return</span> m(<span class=\"code-string\">\"data:\"</span>+b+<span class=\"code-string\">\",\"</span>+<span class=\"code-built_in\">encodeURIComponent</span>(a))}b=<span class=\"code-keyword\">new</span> FileReader,b.onload=<span class=\"code-function\"><span class=\"code-keyword\">function</span>(<span class=\"code-params\">a</span>)</span>{m(<span class=\"code-keyword\">this</span>.result)},b.readAsDataURL(a)}<span class=\"code-keyword\">return</span>!<span class=\"code-number\">0</span>}});\n",""]}}}</script></head><body><div id="root"><style data-emotion-css="gtfibm">html{box-sizing:border-box;}*,*:before,*:after{box-sizing:inherit;}html,body,#root{height:100%;margin:0;}body{font-family:-apple-system, BlinkMacSystemFont, "Segoe UI", "Roboto", "Oxygen", "Ubuntu", "Cantarell", "Fira Sans", "Droid Sans", "Helvetica Neue", sans-serif;font-size:16px;line-height:1.5;overflow-wrap:break-word;background:white;color:black;}code{font-family:Menlo, Monaco, Lucida Console, Liberation Mono, DejaVu Sans Mono, Bitstream Vera Sans Mono, Courier New, monospace;}th,td{padding:0;}select{font-size:inherit;}#root{display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-flex-direction:column;-ms-flex-direction:column;flex-direction:column;}</style><style data-emotion-css="1r6h1r6">.code-listing{background:#fbfdff;color:#383a42;}.code-comment,.code-quote{color:#a0a1a7;font-style:italic;}.code-doctag,.code-keyword,.code-link,.code-formula{color:#a626a4;}.code-section,.code-name,.code-selector-tag,.code-deletion,.code-subst{color:#e45649;}.code-literal{color:#0184bb;}.code-string,.code-regexp,.code-addition,.code-attribute,.code-meta-string{color:#50a14f;}.code-built_in,.code-class .code-title{color:#c18401;}.code-attr,.code-variable,.code-template-variable,.code-type,.code-selector-class,.code-selector-attr,.code-selector-pseudo,.code-number{color:#986801;}.code-symbol,.code-bullet,.code-meta,.code-selector-id,.code-title{color:#4078f2;}.code-emphasis{font-style:italic;}.code-strong{font-weight:bold;}</style><style data-emotion-css="1c3h18e">.css-1c3h18e{-webkit-flex:1 0 auto;-ms-flex:1 0 auto;flex:1 0 auto;}</style><div class="css-1c3h18e"><style data-emotion-css="1cfuj1t">.css-1cfuj1t{max-width:940px;padding:0 20px;margin:0 auto;}</style><div class="css-1cfuj1t"><style data-emotion-css="i51og3">.css-i51og3{margin-top:2rem;}</style><header class="css-i51og3"><style data-emotion-css="1y7u1xh">.css-1y7u1xh{text-align:center;font-size:3rem;-webkit-letter-spacing:0.05em;-moz-letter-spacing:0.05em;-ms-letter-spacing:0.05em;letter-spacing:0.05em;}</style><h1 class="css-1y7u1xh"><style data-emotion-css="1ydg16i">.css-1ydg16i{color:#000;-webkit-text-decoration:none;text-decoration:none;}</style><a href="/" class="css-1ydg16i">UNPKG</a></h1></header></div><div class="css-1cfuj1t"><style data-emotion-css="93o42g">.css-93o42g{display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-flex-direction:row;-ms-flex-direction:row;flex-direction:row;-webkit-align-items:center;-webkit-box-align:center;-ms-flex-align:center;align-items:center;}@media (max-width:700px){.css-93o42g{-webkit-flex-direction:column-reverse;-ms-flex-direction:column-reverse;flex-direction:column-reverse;-webkit-align-items:flex-start;-webkit-box-align:flex-start;-ms-flex-align:flex-start;align-items:flex-start;}}</style><header class="css-93o42g"><style data-emotion-css="1dlpvgi">.css-1dlpvgi{font-size:1.5rem;font-weight:normal;-webkit-flex:1;-ms-flex:1;flex:1;word-break:break-all;}</style><h1 class="css-1dlpvgi"><nav><style data-emotion-css="xt128v">.css-xt128v{color:#0076ff;-webkit-text-decoration:none;text-decoration:none;}.css-xt128v:hover{-webkit-text-decoration:underline;text-decoration:underline;}</style><a href="/browse/downloadjs@1.4.7/" class="css-xt128v">downloadjs</a><style data-emotion-css="lllnmq">.css-lllnmq{padding-left:5px;padding-right:5px;}</style><span class="css-lllnmq">/</span><strong>download.min.js</strong></nav></h1><style data-emotion-css="1nr3dab">.css-1nr3dab{margin-left:20px;}@media (max-width:700px){.css-1nr3dab{margin-left:0;margin-bottom:0;}}</style><p class="css-1nr3dab"><label>Version:<!-- --> <style data-emotion-css="un3bt6">.css-un3bt6{-webkit-appearance:none;-moz-appearance:none;appearance:none;cursor:pointer;padding:4px 24px 4px 8px;font-weight:600;font-size:0.9em;color:#24292e;border:1px solid rgba(27,31,35,.2);border-radius:3px;background-color:#eff3f6;background-image:url(data:image/png;base64,);background-position:right 8px center;background-repeat:no-repeat;background-size:auto 25%;}.css-un3bt6:hover{background-color:#e6ebf1;border-color:rgba(27,31,35,.35);}.css-un3bt6:active{background-color:#e9ecef;border-color:rgba(27,31,35,.35);box-shadow:inset 0 0.15em 0.3em rgba(27,31,35,.15);}</style><select name="version" class="css-un3bt6"><option value="1.3.1">1.3.1</option><option value="1.4.1">1.4.1</option><option value="1.4.2">1.4.2</option><option value="1.4.3">1.4.3</option><option value="1.4.4">1.4.4</option><option value="1.4.6">1.4.6</option><option selected="" value="1.4.7">1.4.7</option></select></label></p></header></div><style data-emotion-css="107j3ms">.css-107j3ms{max-width:940px;padding:0 20px;margin:0 auto;}@media (max-width:700px){.css-107j3ms{padding:0;margin:0;}}</style><div class="css-107j3ms"><style data-emotion-css="q3frg4">.css-q3frg4{border:1px solid #dfe2e5;border-radius:3px;}@media (max-width:700px){.css-q3frg4{border-right-width:0;border-left-width:0;}}</style><div class="css-q3frg4"><style data-emotion-css="10o5omr">.css-10o5omr{padding:10px;background:#f6f8fa;color:#424242;border:1px solid #d1d5da;border-top-left-radius:3px;border-top-right-radius:3px;margin:-1px -1px 0;display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-flex-direction:row;-ms-flex-direction:row;flex-direction:row;-webkit-align-items:center;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-webkit-box-pack:justify;-webkit-justify-content:space-between;-ms-flex-pack:justify;justify-content:space-between;}@media (max-width:700px){.css-10o5omr{padding-right:20px;padding-left:20px;}}</style><div class="css-10o5omr"><span>2.55 kB</span><span>JavaScript</span><span><style data-emotion-css="18x593j">.css-18x593j{display:inline-block;margin-left:8px;padding:2px 8px;-webkit-text-decoration:none;text-decoration:none;font-weight:600;font-size:0.9rem;color:#24292e;background-color:#eff3f6;border:1px solid rgba(27,31,35,.2);border-radius:3px;}.css-18x593j:hover{background-color:#e6ebf1;border-color:rgba(27,31,35,.35);}.css-18x593j:active{background-color:#e9ecef;border-color:rgba(27,31,35,.35);box-shadow:inset 0 0.15em 0.3em rgba(27,31,35,.15);}</style><a href="/downloadjs@1.4.7/download.min.js" class="css-18x593j">View Raw</a></span></div><style data-emotion-css="1i31ihw">.css-1i31ihw{overflow-x:auto;overflow-y:hidden;padding-top:5px;padding-bottom:5px;}</style><div class="code-listing css-1i31ihw"><style data-emotion-css="173nir8">.css-173nir8{border:none;border-collapse:collapse;border-spacing:0;}</style><table class="css-173nir8"><tbody><tr><style data-emotion-css="a4x74f">.css-a4x74f{padding-left:10px;padding-right:10px;color:rgba(27,31,35,.3);text-align:right;vertical-align:top;width:1%;min-width:50px;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;}</style><td id="L1" class="css-a4x74f"><span>1</span></td><style data-emotion-css="1dcdqdg">.css-1dcdqdg{padding-left:10px;padding-right:10px;color:#24292e;white-space:pre;}</style><td id="LC1" class="css-1dcdqdg"><code><span class="code-comment">//download.js v4.2, by dandavis; 2008-2017. [MIT] see http://danml.com/download.html for tests/usage</span>
</code></td></tr><tr><td id="L2" class="css-a4x74f"><span>2</span></td><td id="LC2" class="css-1dcdqdg"><code>;(<span class="code-function"><span class="code-keyword">function</span>(<span class="code-params">r,l</span>)</span>{<span class="code-string">"function"</span>==<span class="code-keyword">typeof</span> define&amp;&amp;define.amd?define([],l):<span class="code-string">"object"</span>==<span class="code-keyword">typeof</span> exports?<span class="code-built_in">module</span>.exports=l():r.download=l()})(<span class="code-keyword">this</span>,<span class="code-function"><span class="code-keyword">function</span>(<span class="code-params"></span>)</span>{<span class="code-keyword">return</span> <span class="code-function"><span class="code-keyword">function</span> <span class="code-title">l</span>(<span class="code-params">a,e,k</span>)</span>{<span class="code-function"><span class="code-keyword">function</span> <span class="code-title">q</span>(<span class="code-params">a</span>)</span>{<span class="code-keyword">var</span> h=a.split(<span class="code-regexp">/[:;,]/</span>);a=h[<span class="code-number">1</span>];<span class="code-keyword">var</span> h=(<span class="code-string">"base64"</span>==h[<span class="code-number">2</span>]?atob:<span class="code-built_in">decodeURIComponent</span>)(h.pop()),d=h.length,b=<span class="code-number">0</span>,c=<span class="code-keyword">new</span> <span class="code-built_in">Uint8Array</span>(d);<span class="code-keyword">for</span>(b;b&lt;d;++b)c[b]=h.charCodeAt(b);<span class="code-keyword">return</span> <span class="code-keyword">new</span> f([c],{<span class="code-attr">type</span>:a})}<span class="code-function"><span class="code-keyword">function</span> <span class="code-title">m</span>(<span class="code-params">a,b</span>)</span>{<span class="code-keyword">if</span>(<span class="code-string">"download"</span><span class="code-keyword">in</span> d)<span class="code-keyword">return</span> d.href=a,d.setAttribute(<span class="code-string">"download"</span>,n),d.className=<span class="code-string">"download-js-link"</span>,d.innerHTML=<span class="code-string">"downloading..."</span>,d.style.display=<span class="code-string">"none"</span>,<span class="code-built_in">document</span>.body.appendChild(d),setTimeout(<span class="code-function"><span class="code-keyword">function</span>(<span class="code-params"></span>)</span>{d.click(),<span class="code-built_in">document</span>.body.removeChild(d),!<span class="code-number">0</span>===b&amp;&amp;setTimeout(<span class="code-function"><span class="code-keyword">function</span>(<span class="code-params"></span>)</span>{g.URL.revokeObjectURL(d.href)},<span class="code-number">250</span>)},<span class="code-number">66</span>),!<span class="code-number">0</span>;<span class="code-keyword">if</span>(<span class="code-regexp">/(Version)\/(\d+)\.(\d+)(?:\.(\d+))?.*Safari\//</span>.test(navigator.userAgent))<span class="code-keyword">return</span><span class="code-regexp">/^data:/</span>.test(a)&amp;&amp;(a=<span class="code-string">"data:"</span>+a.replace(<span class="code-regexp">/^data:([\w\/\-\+]+)/</span>,<span class="code-string">"application/octet-stream"</span>)),!<span class="code-built_in">window</span>.open(a)&amp;&amp;confirm(<span class="code-string">"Displaying New Document\n\nUse Save As... to download, then click back to return to this page."</span>)&amp;&amp;(location.href=a),!<span class="code-number">0</span>;<span class="code-keyword">var</span> c=<span class="code-built_in">document</span>.createElement(<span class="code-string">"iframe"</span>);<span class="code-built_in">document</span>.body.appendChild(c),!b&amp;&amp;<span class="code-regexp">/^data:/</span>.test(a)&amp;&amp;(a=<span class="code-string">"data:"</span>+a.replace(<span class="code-regexp">/^data:([\w\/\-\+]+)/</span>,<span class="code-string">"application/octet-stream"</span>)),c.src=a,setTimeout(<span class="code-function"><span class="code-keyword">function</span>(<span class="code-params"></span>)</span>{<span class="code-built_in">document</span>.body.removeChild(c)},<span class="code-number">333</span>)}<span class="code-keyword">var</span> g=<span class="code-built_in">window</span>,b=k||<span class="code-string">"application/octet-stream"</span>,c=!e&amp;&amp;!k&amp;&amp;a,d=<span class="code-built_in">document</span>.createElement(<span class="code-string">"a"</span>);k=<span class="code-function"><span class="code-keyword">function</span>(<span class="code-params">a</span>)</span>{<span class="code-keyword">return</span> <span class="code-built_in">String</span>(a)};<span class="code-keyword">var</span> f=g.Blob||g.MozBlob||g.WebKitBlob||k,n=e||<span class="code-string">"download"</span>,f=f.call?f.bind(g):Blob;<span class="code-string">"true"</span>===<span class="code-built_in">String</span>(<span class="code-keyword">this</span>)&amp;&amp;(a=[a,b],b=a[<span class="code-number">0</span>],a=a[<span class="code-number">1</span>]);<span class="code-keyword">if</span>(c&amp;&amp;<span class="code-number">2048</span>&gt;c.length&amp;&amp;(n=c.split(<span class="code-string">"/"</span>).pop().split(<span class="code-string">"?"</span>)[<span class="code-number">0</span>],d.href=c,<span class="code-number">-1</span>!==d.href.indexOf(c))){<span class="code-keyword">var</span> p=<span class="code-keyword">new</span> XMLHttpRequest;<span class="code-keyword">return</span> p.open(<span class="code-string">"GET"</span>,c,!<span class="code-number">0</span>),p.responseType=<span class="code-string">"blob"</span>,p.onload=<span class="code-function"><span class="code-keyword">function</span>(<span class="code-params">a</span>)</span>{l(a.target.response,n,<span class="code-string">"application/octet-stream"</span>)},setTimeout(<span class="code-function"><span class="code-keyword">function</span>(<span class="code-params"></span>)</span>{p.send()},<span class="code-number">0</span>),p}<span class="code-keyword">if</span>(<span class="code-regexp">/^data:([\w+-]+\/[\w+.-]+)?[,;]/</span>.test(a)){<span class="code-keyword">if</span>(!(<span class="code-number">2096103.424</span>&lt;a.length&amp;&amp;f!==k))<span class="code-keyword">return</span> navigator.msSaveBlob?navigator.msSaveBlob(q(a),n):m(a);a=q(a),b=a.type||<span class="code-string">"application/octet-stream"</span>}<span class="code-keyword">else</span> <span class="code-keyword">if</span>(<span class="code-regexp">/([\x80-\xff])/</span>.test(a)){e=<span class="code-number">0</span>;<span class="code-keyword">var</span> c=<span class="code-keyword">new</span> <span class="code-built_in">Uint8Array</span>(a.length),t=c.length;<span class="code-keyword">for</span>(e;e&lt;t;++e)c[e]=a.charCodeAt(e);a=<span class="code-keyword">new</span> f([c],{<span class="code-attr">type</span>:b})}a=a <span class="code-keyword">instanceof</span> f?a:<span class="code-keyword">new</span> f([a],{<span class="code-attr">type</span>:b});<span class="code-keyword">if</span>(navigator.msSaveBlob)<span class="code-keyword">return</span> navigator.msSaveBlob(a,n);<span class="code-keyword">if</span>(g.URL)m(g.URL.createObjectURL(a),!<span class="code-number">0</span>);<span class="code-keyword">else</span>{<span class="code-keyword">if</span>(<span class="code-string">"string"</span>==<span class="code-keyword">typeof</span> a||a.constructor===k)<span class="code-keyword">try</span>{<span class="code-keyword">return</span> m(<span class="code-string">"data:"</span>+b+<span class="code-string">";base64,"</span>+g.btoa(a))}<span class="code-keyword">catch</span>(h){<span class="code-keyword">return</span> m(<span class="code-string">"data:"</span>+b+<span class="code-string">","</span>+<span class="code-built_in">encodeURIComponent</span>(a))}b=<span class="code-keyword">new</span> FileReader,b.onload=<span class="code-function"><span class="code-keyword">function</span>(<span class="code-params">a</span>)</span>{m(<span class="code-keyword">this</span>.result)},b.readAsDataURL(a)}<span class="code-keyword">return</span>!<span class="code-number">0</span>}});
