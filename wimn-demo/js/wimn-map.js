			...
			id: "55ebf90799fa4a3fa57562700a68c405" // streets
				...
				//executeIdentifyPOI(searchTolerance, [1,3, 5]);
                    ...
                    function executeIdentifyCTU(tolerance) {
                        ...
                        divStr = "The map is set to a " + scale + " scale";
                        ...
                        if (zoomL <= 8) {
                            ...
                            div.innerHTML = divStr + "."; //". Zoom in to query cities, townships, and counties";
            
                        } else {
            
                            divStr = divStr + " and contains the following: ";
             ...
             //       userNoteInfo.setAttribute('aria-live', 'assertive');
                    ...
                    function executeIdentifyPOI(tolerance, layerIds) {
                        ...
                        identify
                            ...
                            mapDescription.innerHTML="<p>This " + JSON.stringify(map.basemap.title) + " map contains the following sites: ";
